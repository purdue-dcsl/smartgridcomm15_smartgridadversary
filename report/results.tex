...
\begin{figure*}[htp]
    \centering
    \subfigure[Scenario 1]{\includegraphics[width=.5\textwidth]{naieve-equal-attacks.png}}\hfill
    \subfigure[Scenario 2]{\includegraphics[width=.5\textwidth]{naieve-unequal-attacks.png}}  
...
\begin{figure*}[htp]
    \centering
    \subfigure[Scenario 1]{\includegraphics[width=.5\textwidth]{equal-attacks.png}}\hfill
    \subfigure[Scenario 2]{\includegraphics[width=.5\textwidth]{unequal-attacks.png}}  
    \caption{Results for Naieve Attacker}
    \label{strategic}  
\end{figure*}
